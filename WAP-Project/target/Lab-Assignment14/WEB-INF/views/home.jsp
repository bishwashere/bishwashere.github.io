...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<%=application.getContextPath() %>/css/all.css" >

    <link rel="stylesheet" type="text/css"
          href="<%=application.getContextPath() %>/css/sb-admin-2.css" >
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Inventory Requests Stats</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                    ...
                    <span class="mr-2">
                      <i class="fas fa-circle text-primary"></i> Requested %
                    </span>
                                        <span class="mr-2">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var pieChartData = '<%= (float []) request.getAttribute("pieChartData") %>';
        var pieChartData = new Array();

            var i = 0;
            <c:forEach items="${pieChartData}" var="current" varStatus="status">
             pieChartData[i] = '<c:out value='${current}'/>';
            i++;
            </c:forEach>
...
var pieChartData = [
        ...
        var myPieChart = new Chart(ctx, {
            type: 'doughnut',
            data: {
                labels: ["Requests", "Approved", "Declined"],
                datasets: [{
                    data: pieChartData,
